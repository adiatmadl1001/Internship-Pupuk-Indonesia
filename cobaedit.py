...
time.sleep(3)
driver.find_element(By.XPATH,"/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/section[1]/section[1]/main[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[2]/td[7]/div[1]/div[2]/button[1]/span[1]/*[name()='svg'][1]").click()
driver.find_element(By.ID,"fullName").send_keys("TADI")
